...
public interface Perfume_StoryDAO {
	...
	// 글 조회수 증가
	void storyViewCount(Perfume_StoryVO vo) ;
	...
	// 댓글 목록 조회
	List<Perfume_Story_CommVO> commList(int ps_article_id) throws Exception;
	 
	// 댓글 등록
	void insertComm(Perfume_Story_CommVO commVo) throws Exception;
	
	// 댓글 수정
	void updateComm(Perfume_Story_CommVO commVo) throws Exception;
	 
	// 댓글 삭제
	void deleteComm(Perfume_Story_CommVO commVo) throws Exception;
