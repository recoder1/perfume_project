...
@Getter
@Setter
public class PageMakerGyu {

	private CriteriaGyu cri;	//
	private int totalCount; // 게시물의 총 갯수
	 ...
	 private int displayPageNum = 10; // 화면에 표시할 페이지 번호 개수

	 

	 public CriteriaGyu getCri() {
	        return cri;
	    }
	    public void setCri(CriteriaGyu cri) {
	        this.cri = cri;
	    }
...
//				 .queryParam("searchType", ((SearchCriteria)cri).getSearchType())
				 .queryParam("keyword", encoding(((SearchCriteriaGyu)cri).getKeyword()))
//				 .queryParam("brand", ((SearchCriteria)cri).getBrand())
				 .build();
