...
<script type="text/javascript">
	$(document).ready(function(){
		...
		$("#insertBtn").click(function(){
			...
			document.formSave.action="saveMarket.do";
                      ...
                      <form method='post'  name="formSave" role="formSave" enctype="multipart/form-data">
                          ...
                          <div type="hidden" name="m_article_id" value="${m_article_id}"></div>
                           ...
                           <div class="col-12 col-md-12">
                               ...
                               <input class="form-control" id="market_write2" type="text" name="m_product" placeholder="상품명" required="">
                           </div>
                           <div class="col-12 col-md-12">
                              <label class="form-label" for="market_write3" style="display:block">
                                 	실구매가
                              </label>
                              <input class="form-control" type="text" id="market_write3" name="m_pastprice" 
                              placeholder="구매한 가격을 입력해주세요" style="display:inline; width: 230px;" required
                           ...
                           <div class="col-12 col-md-12">
                               <label class="form-label" for="market_write4" style="display:block">
                                ...
                                <input class="form-control" type="text" id="market_write4" name="m_saleprice" 
                                	placeholder="희망 판매가격을 입력해주세요" required="" style="display:inline; width:230px;"
                                	onKeyup="this.value=this.value.replace(/[^0-9]/g,'');" />
                                <span> 원</span>
                           </div>
                           <div class="col-12 col-md-12">
                               ...
                               <input class="form-control" id="market_write5" type="date" name="m_purdate" style="width: 230px;" required="">
                           </div>
                           <div class="col-12 col-md-12">
                               <label class="form-label" for="market_write6">
                                   	유통기한
                               </label>
                               <input class="form-control" id="market_write6" type="date" name="m_expdate" style="width: 230px;" required="">
                           </div>
                           <div class="col-12 col-md-12">
                               <label class="form-label" for="market_write7">
                                   	구매처
                               </label>
                               <input class="form-control" id="market_write7" type="text" name="m_place" placeholder="구매처를 입력해주세요" required="" >
                           </div>
                           <div class="col-12 col-md-12">
                               <label class="form-label" for="market_write8">
                                  	 브랜드
                               </label>
                               <input class="form-control" id="market_write8" type="text" name="m_brand" placeholder="브랜드를 입력해주세요" required="">
                           </div>
                           <div class="col-12 col-md-12">
                               ...
                               <input class="form-control" id="market_write9" type="text" name="m_size" 
                               	placeholder="용량을 입력해주세요" style="display:inline; width:230px" 
                           ...
                           <div class="col-12 col-md-12">
                               <label class="form-label" for="market_write11" >
								...
								<div class="btn-group-toggle" data-bs-toggle="buttons">
	                               ...
	                               <input type="radio" class="btn-check" name="m_saleway" id="condition5" value="직거래">
                           ...
                           <div class="col-12 col-md-12">
                               ...
                               <textarea class="form-control" id="market_write12" type="text" name="m_content" placeholder="판매하실 상품에 대해 알려주세요"></textarea>
                           </div>
                           ...
                           <div class="col-12 col-md-12">
                               <label class="form-label" for="market_write13">
                                   	사진첨부
                               </label>
                               <input class="form-control" id="market_write13" name="file" type="file" >
                           </div>
