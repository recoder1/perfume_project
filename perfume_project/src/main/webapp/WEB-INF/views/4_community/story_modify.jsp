...
<script type="text/javascript">
	$(document).ready(function(){
		...
		$("#updateBtn").click(function(){
			...
			document.formUpdate.action="updateBoard.do";
              ...
              <div class="card-header py-3">
               ...
               <div class="card-body">
                 <div class="row gy-4">
                 	...
                 	<!-- form -->
      				<form method='post' name="formUpdate" role="formUpdate" enctype="multipart/form-data">
                       <div class="col-12 mb-3 input-group" style="width: 100%">
							  <input type="hidden" name="ps_article_id" value="${board.ps_article_id}" ></input>
                          ...
                          <select class="form-select" name="ps_head" style="flex:none; width: 20%;">
                           ...
                           <!-- 글 제목 -->
                           <input class="form-control" type="text" name="ps_title" placeholder="제목" value="${board.ps_title}"  required="" />
                        ...
                        <div class="col-12">
                            ...
                            <textarea class="form-control" id="coumnity_form1" name="ps_content" style="height: 500px">${board.ps_content}</textarea>
                        </div>
                        <!-- 사진첨부 -->
                        <div class="col-12">
                        ...
                        <div class="col-12 pt-3 text-end">
                            <button class="btn btn-primary" id="updateBtn" type="button">올리기</button>
                            <button class="btn btn-primary" id="cancelBtn" onclick="location.href='story_list.do'">취소</button>
                        </div>
                   	</form>
                  </div>
              </div>
